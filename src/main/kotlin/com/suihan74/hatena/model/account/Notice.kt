...
data class Notice(
    ...
    @SerialName("object")
    val objects : List<com.suihan74.hatena.model.account.Notice.NoticeObject>,
    ...
    val metadata : com.suihan74.hatena.model.account.Notice.NoticeMetadata? = null
) {
    val eid : Long by lazy {
        if (verb == com.suihan74.hatena.model.account.Notice.Verb.STAR.value) {
