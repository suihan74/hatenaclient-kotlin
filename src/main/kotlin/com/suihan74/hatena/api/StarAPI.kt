 ...
 * 認証が必要なスター関連のAPI
 */
interface CertifiedStarAPI : StarAPI {
 ...
 * スターを投稿する
 */
suspend fun CertifiedStarAPI.postStar(
    url: String,
    color: StarColor,
    quote: String? = null
) {
...
class CertifiedStarAPIImpl(
    delegate : CertifiedStarAPI
) : CertifiedStarAPI by delegate {
